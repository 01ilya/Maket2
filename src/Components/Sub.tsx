...
export default function Sub() {
  return (
    <div className='flex bg-primary py-20 px-[405px] justify-center items-centr gap-32 shrink-0'>
      ...
      <div>
        <h2 className='text-white Headline_2_ExtraBold'>Subscribe to our newsletter</h2>
      ...
      <div className='flex items-centr justify-center h-11 rounded-md mt-10'>
        ...
        <button className='flex items-center bg-white rounded-r-md justify-center w-32 h-11 '><h6 className='Headline_6_ExtraBold text-black'>Send</h6></button>
