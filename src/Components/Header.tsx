  ...
  return (
    <div className='flex justtify-center items-center gap-36 shrink-0 px-[405px] py-10 sm:flex sm:px-0'>
      ...
      <div className='flex justify-between items-center w-full pr-5 sd:hidden  ' onClick={handleNav}>
        ...
        {!header ? <img src='./images/logohederwhite.svg' className='sm:pl-4 z-50 w-[157px]' /> : <img src='./images/logoheder.svg' className='sm:pl-4' />}
        {!header ? <img src='./images/dismiss.svg' className='z-10' /> : <img src='./images/navigation.svg' />}

      </div>
      <div className={!header ? 'bg-primary fixed top-0 w-full h-full pt-28' : 'hidden'}>
