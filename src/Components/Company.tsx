...
export default function Company() {
  const infoCompany: CompanyItems[] = [{ text1: '1830+', text2: 'Project executed', }, { text1: '220', text2: 'Project executed' }, { text1: '390', text2: 'Data management' }, { text1: '834+', text2: 'Satisfied customers' }];
  return (
